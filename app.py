...
st.markdown(
    ...
    <div class="footer-copyright">
        copyright © 2026 PT Indonesia Juara Semesta. Hak Cipta Dilindungi Undang-Undang.<br>
        Dikembangkan oleh Ade Dimas Shirotuddin sebagai Inisiatif Peningkatan Kinerja Internal.
    </div>
    """,
    unsafe_allow_html=True
)